...
public class objectDetectorClass {
    ...
    // this is used to load model and predit
...
//        options.addDelegate(gpuDelegate);
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        // now predict
        // 이후 예측 모델과 변환 모델의 runForMultipleInputsOutputs 함수를 이용해서, 변환 작업을 진행한 뒤, 결과 값을 비트맵으로 만드는 과정을 진행한다.
